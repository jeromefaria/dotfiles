...
alias update='sudo softwareupdate -i -a && mas upgrade && brew update && brew upgrade && brew cask upgrade --greedy && brew cleanup && sudo npm install -g npm && sudo npm update -g && gem update --system && gem update && gem cleanup && tldr --update && sudo youtube-dl -U'
