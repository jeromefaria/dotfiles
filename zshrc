...
plugins=(git svn sublime osx encode64 web-search last-working-dir git-flow-completion zsh-syntax-highlighting vi-mode zsh-autosuggestions git-open brew bundler rbenv colored-man-pages)
